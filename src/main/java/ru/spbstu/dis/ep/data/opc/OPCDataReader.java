...
public class OPCDataReader {
  ...
  private final HashMap<Tag, Item> itemsToRead = Maps.newHashMap();
  ...
  throws UnknownHostException, JIException, AlreadyConnectedException, NotConnectedException,
    ...
    ci.setPassword("seal");
    ci.setClsid("6F17505C-4351-46AC-BC1E-CDE34BB53FAA"); //--- real server
//    ci.setClsid("2E565242-B238-11D3-842D-0008C779D775");
    //2E565242-B238-11D3-842D-0008C779D775 --- artificial server
  ...
  public HashMap<Tag, Item> getItemsToRead() {
    return itemsToRead;
  }
}
