...
public class DecisionSupportList {
    ...
    public DecisionSupportList(final String title) {
        ...
        final JFreeChart chart = createCombinedChart("Trend Line");
        final ChartPanel panel = new ChartPanel(chart, true, true, true, false, true);
        panel.setPreferredSize(new java.awt.Dimension(500, 270));
//        setContentPane(panel);
        frame = new JFrame( "Emergency control panel" );
        ...
        JPanel p = new JPanel();
        p.add(new JLabel("Emergency situation prediction"));
        p.add(panel);
        p.add( list );
    ...
    public
    void setSeries(TimeSeries series) {
        this.series = series;
    }
